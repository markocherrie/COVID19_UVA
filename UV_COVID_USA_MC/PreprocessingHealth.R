################# CODE from: https://github.com/wxwx1993/PM_COVID/blob/master/Preprocessing.R
...
state_test = read.csv("data/HealthPop/dailytests.csv")
state_test = subset(state_test, date ==paste0(substring(str_remove_all(date_of_study, "-"),5,8),"0414"))[,-20]


statecode = read.csv(text=getURL("https://raw.githubusercontent.com/wxwx1993/PM_COVID/master/Data/statecode.csv"))

hospitals = read.csv("Data/HealthPop/Hospitals.csv")
